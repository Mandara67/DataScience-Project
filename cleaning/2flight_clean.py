...
df["ARR_DELAYED"] = (df["ARR_DELAY"] > 0).astype(int) # If arrival delayed, set to 1, else 0
df["DEP_DELAYED"] = (df["DEP_DELAY"] > 0).astype(int) # If departure delayed, set to 1, else 0
